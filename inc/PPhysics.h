...
class	PPhysics : virtual public GTreeManager
{
 ...
 public:
  ...
  void	FillThetaMissingMass(const GTreeParticle& tree, GH2* gHist, Bool_t TaggerBinning = kFALSE);
  void	FillThetaMissingMass(const GTreeParticle& tree, Int_t particle_index, GH2* gHist, Bool_t TaggerBinning = kFALSE);
  void 	FillThetaMissingMass(const GTreeParticle& tree, Int_t particle_index, Int_t tagger_index, GH2* gHist, Bool_t TaggerBinning = kFALSE);

  void	FillTaggedPhotons(const GTreeParticle& tree, GH1* gHist);
  void	FillTaggedPhotons(const GTreeParticle& tree, Int_t particle_index, GH1* gHist);
  void 	FillTaggedPhotons(const GTreeParticle& tree, Int_t particle_index, Int_t tagger_index, GH1* gHist);
...
//      ||||||||||||||||||||
  ...
  void 	FillThetaMass(const GTreeParticle& tree, GH2* gHist);
  void 	FillThetaMass(const GTreeParticle& tree, Int_t particle_index, GH2* gHist);
